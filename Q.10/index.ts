...
const favoriteNumber: number = 8; // Storing my favorite number
console.log(`My favorite number is ${favoriteNumber}.`); // Printing message revealing my favorite number
