...
var current_users = ["Ahmed", "Ali", "Admin", "Hafsa", "Moiz"];
var new_users = ["Fawad", "Hamza", "Ammar", "Ahmed", "Moiz"];
new_users.forEach(function (newUser) {
    var newUserLower = newUser.toLowerCase();
    if (current_users.some(function (user) { return user.toLowerCase() === newUserLower; })) {
